...
/**
 * Algorithme A* (A-Star)
 * Explore les nœuds par ordre croissant de f(n) = g(n) + h(n)
 * où g(n) est le coût du chemin et h(n) l'heuristique
 */
public class AStar extends TreeSearch {

    public AStar(SearchProblem prob, State initial_state){
        super(prob, initial_state);
        // File de priorité ordonnée par f(n) = g(n) + h(n) croissant
    ...
    public boolean solve() {
        ...
        while (!this.frontier.isEmpty()) {
            ...
            // 5 Retirer le nœud de f(n) minimal
